...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "C##KH"."DEPARTMENT"."DEPT_ID" IS '부서코드';
   COMMENT ON COLUMN "C##KH"."DEPARTMENT"."DEPT_TITLE" IS '부서명';
   COMMENT ON COLUMN "C##KH"."DEPARTMENT"."LOCATION_ID" IS '지역코드';
   COMMENT ON TABLE "C##KH"."DEPARTMENT"  IS '부서';
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##KH"."엔터티1_PK2" ON "C##KH"."DEPARTMENT" ("DEPT_ID") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##KH"."DEPARTMENT" ADD CONSTRAINT "DEPARTMENT_PK" PRIMARY KEY ("DEPT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "C##KH"."DEPARTMENT" MODIFY ("LOCATION_ID" NOT NULL ENABLE);
  ALTER TABLE "C##KH"."DEPARTMENT" MODIFY ("DEPT_ID" NOT NULL ENABLE);

--------------------------------------------------------
--  DDL for Table EMPLOYEE
--------------------------------------------------------

  CREATE TABLE "C##KH"."EMPLOYEE" 
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."EMP_ID" IS '사원번호';
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."EMP_NAME" IS '직원명';
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."EMP_NO" IS '주민등록번호';
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."EMAIL" IS '이메일';
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."PHONE" IS '전화번호';
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."DEPT_CODE" IS '부서코드';
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."JOB_CODE" IS '직급코드';
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."SALARY" IS '급여';
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."BONUS" IS '보너스율';
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."MANAGER_ID" IS '관리자사번';
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."HIRE_DATE" IS '입사일';
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."ENT_DATE" IS '퇴사일';
   COMMENT ON COLUMN "C##KH"."EMPLOYEE"."ENT_YN" IS '퇴직여부';
   COMMENT ON TABLE "C##KH"."EMPLOYEE"  IS '사원';
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##KH"."엔터티1_PK" ON "C##KH"."EMPLOYEE" ("EMP_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##KH"."EMPLOYEE" ADD CONSTRAINT "EMPLOYEE_PK" PRIMARY KEY ("EMP_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "C##KH"."EMPLOYEE" MODIFY ("JOB_CODE" NOT NULL ENABLE);
  ALTER TABLE "C##KH"."EMPLOYEE" MODIFY ("EMP_NO" NOT NULL ENABLE);
  ALTER TABLE "C##KH"."EMPLOYEE" MODIFY ("EMP_NAME" NOT NULL ENABLE);
  ALTER TABLE "C##KH"."EMPLOYEE" MODIFY ("EMP_ID" NOT NULL ENABLE);

--------------------------------------------------------
--  DDL for Table JOB
--------------------------------------------------------

  CREATE TABLE "C##KH"."JOB" 
   (   "JOB_CODE" CHAR(2 BYTE), 
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "C##KH"."JOB"."JOB_CODE" IS '직급코드';
   COMMENT ON COLUMN "C##KH"."JOB"."JOB_NAME" IS '직급명';
   COMMENT ON TABLE "C##KH"."JOB"  IS '직급';
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##KH"."엔터티1_PK1" ON "C##KH"."JOB" ("JOB_CODE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##KH"."JOB" ADD CONSTRAINT "JOB_PK" PRIMARY KEY ("JOB_CODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "C##KH"."JOB" MODIFY ("JOB_CODE" NOT NULL ENABLE);

--------------------------------------------------------
--  DDL for Table LOCATION
--------------------------------------------------------

  CREATE TABLE "C##KH"."LOCATION" 
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "C##KH"."LOCATION"."LOCAL_CODE" IS '지역코드';
   COMMENT ON COLUMN "C##KH"."LOCATION"."NATIONAL_CODE" IS '국가코드';
   COMMENT ON COLUMN "C##KH"."LOCATION"."LOCAL_NAME" IS '지역명';
   COMMENT ON TABLE "C##KH"."LOCATION"  IS '지역';
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##KH"."엔터티1_PK3" ON "C##KH"."LOCATION" ("LOCAL_CODE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##KH"."LOCATION" ADD CONSTRAINT "LOCATION_PK" PRIMARY KEY ("LOCAL_CODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "C##KH"."LOCATION" MODIFY ("NATIONAL_CODE" NOT NULL ENABLE);
  ALTER TABLE "C##KH"."LOCATION" MODIFY ("LOCAL_CODE" NOT NULL ENABLE);

--------------------------------------------------------
--  DDL for Table NATIONAL
--------------------------------------------------------

  CREATE TABLE "C##KH"."NATIONAL" 
   (   "NATIONAL_CODE" CHAR(2 BYTE), 
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "C##KH"."NATIONAL"."NATIONAL_CODE" IS '국가코드';
   COMMENT ON COLUMN "C##KH"."NATIONAL"."NATIONAL_NAME" IS '국가명';
   COMMENT ON TABLE "C##KH"."NATIONAL"  IS '국가';
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##KH"."엔터티1_PK4" ON "C##KH"."NATIONAL" ("NATIONAL_CODE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##KH"."NATIONAL" ADD CONSTRAINT "NATIONAL_PK" PRIMARY KEY ("NATIONAL_CODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "C##KH"."NATIONAL" MODIFY ("NATIONAL_CODE" NOT NULL ENABLE);

--------------------------------------------------------
--  DDL for Table SAL_GRADE
--------------------------------------------------------

  CREATE TABLE "C##KH"."SAL_GRADE" 
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "C##KH"."SAL_GRADE"."SAL_LEVEL" IS '급여등급';
   COMMENT ON COLUMN "C##KH"."SAL_GRADE"."MIN_SAL" IS '최소급여';
   COMMENT ON COLUMN "C##KH"."SAL_GRADE"."MAX_SAL" IS '최대급여';
   COMMENT ON TABLE "C##KH"."SAL_GRADE"  IS '급여등급';
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "C##KH"."엔터티2_PK" ON "C##KH"."SAL_GRADE" ("SAL_LEVEL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##KH"."SAL_GRADE" ADD CONSTRAINT "엔터티2_PK" PRIMARY KEY ("SAL_LEVEL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "C##KH"."SAL_GRADE" MODIFY ("SAL_LEVEL" NOT NULL ENABLE);
